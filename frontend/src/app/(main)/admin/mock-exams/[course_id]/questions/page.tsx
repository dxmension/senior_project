...
export default function AdminMockExamQuestionBankPage({
  params,
}: {
  params: PageParams;
}) {
  ...
  if (!Number.isInteger(courseId) || courseId <= 0) {
    return (
      <div className="flex h-screen flex-col items-center justify-center gap-4">
        ...
        <p className="text-text-secondary">
          The requested question bank page could not be opened.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto max-w-[1600px] overflow-x-hidden">
      <MockExamCourseManagement courseId={courseId} view="questions" />
    </div>
  );
}
