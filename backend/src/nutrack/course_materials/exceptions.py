...
class CourseMaterialError(AppException):
    pass


class CourseMaterialValidationError(CourseMaterialError):
...
class CourseMaterialForbiddenError(CourseMaterialError):
...
class CourseMaterialNotFoundError(CourseMaterialError):
...
class CourseMaterialQueueError(CourseMaterialError):
    def __init__(self) -> None:
        super().__init__(
