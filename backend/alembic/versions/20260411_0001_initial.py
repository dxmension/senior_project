...
down_revision: Union[str, None] = "0002_handbook"
...
def upgrade() -> None:
    ...
    if "course_offerings" not in existing:
        op.create_table(
            "course_offerings",
    ...
    if "course_gpa_stats" not in existing:
        op.create_table(
            "course_gpa_stats",
            sa.Column("course_id", sa.Integer(), nullable=False),
            sa.Column("term", sa.String(length=16), nullable=False),
    ...
    if "course_reviews" not in existing:
        op.create_table(
            "course_reviews",
            sa.Column("course_id", sa.Integer(), nullable=False),
            sa.Column("user_id", sa.Integer(), nullable=False),
